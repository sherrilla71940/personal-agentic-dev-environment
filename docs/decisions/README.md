...
| [0014](./0014-machine-local-ai-configuration-profiles.md) | Accepted | Compose machine-local context and continuity profiles without duplicating skills; extended by 0021 |
...
| [0021](./0021-add-native-workflow-profile-mode.md) | Accepted | Add an independent native mode that keeps shared capabilities while disabling automatic workflow orchestration |
