...
Repeat the repository verification after a Codex session ended while preserving the current task.

## Current phase

The prior Codex session used private project override instructions, but it did not copy those
